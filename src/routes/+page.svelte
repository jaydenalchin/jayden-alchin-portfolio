<hero class="bg-primary flex w-screen h-screen justify-center items-center">
    <header class="text-white flex flex-col justify-center items-center text-center p-4">
        ...
        <div class="text-black text-3xl max-md:text-lg font-bold whitespace-nowrap bg-white mt-24 px-24 py-8 max-md:px-8 max-md:py-4 rounded-2xl max-md:rounded-lg border-4 border-black">
            In Development
        </div>
    </header>
</hero>